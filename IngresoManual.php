...
<!-- Confesion: Esta es un "Pagina espejo" del ingreso.php por que no pude hacer un boton que cambie el cbx a txt osea pude pero la id no podia ser la misma y me arrojaba error... Asi que me fui por lo mas facil e hice este "espejo" que al final sirve por que si la pantalla de ingresos normal no funciona por las patentes, esta la reemplaza sin problemas -->
...
$fecha=date('F');
$fecha=strftime('%B');
$Sql="INSERT INTO ingresos(Mes,Faena,Fecha,Turno,Hora,Patente,Tipo_Operacion,Procedencia,Contenedor,Iso_Code,Observacion,Empleado) VALUES('".$fecha."','','".date('y-m-d')."','','".date('H:i:s')."','"
.$_POST['patente']."','"
.$_POST['operacion']."','"
.$_POST['procedencia']."','";
...
<body>
<!--Funcion que sirve para el boton al momento de que salga un error o un success cuando se ingresa-->
<script>
...
<a style="	font-size:30px;
    ...
    <a href="ingreso.php"><input style="width:180px" type="button" name="button" value="Modo Normal" ></a>
...
$sql="SELECT I.patente,
		T.operacion,
		P.Procedencia,
		IFNULL(IC.descrip, 'N/A') as 'descrip' ,
