...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Cantidad de operaciones realizadas de salida de TCVAL'
        },
        subtitle: {
            text: ''
        },
        xAxis: {
			<!--Grafico de barra-->
			<!--Pide 2 resultados este es el primero en donde se agregan solamente los nombres que van a estar en Y-->
            categories: [
<?php
...
while($raw=mysqli_fetch_array($result)){
        ...
        series: [{
            name: 'Cantidad',
            data: [
			<!--Aqui se encuentran los valores X (los numeros)-->

			
<!--Para poder filtrar por la fecha-->			
<?php
$mysqli = new mysqli("localhost","root","31Ordnajela$","proyecto");
...
<!--Aqui estan los Scripts para la barra de navegacion-->
...
<!--php para identificar el dispositivo-->
<?php
...
<div class="Formulario">
    ...
    <form method="POST" action="#"> 
        ...
        <!-- Llamar la fecha actual para insertarla al value del input date  -->
          <?php 
        $month = date('m');
        $day = date('d');
        $year = date('Y');
