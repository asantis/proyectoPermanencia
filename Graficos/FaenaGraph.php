...
$sql = "select f.nombre, count(s.faena) as 'CantidadFaena' from salidas s
join faenas f on f.idfaena=s.Faena
group by f.nombre
order by CantidadFaena desc";
...
if ($result->num_rows > 0 ){
	...
	?>
	<?php echo $row['CantidadFaena'] ?>,<?php 
	}
}
	echo($exit);
	$mysqli->close();
...
<a href="FaenaGraph.php"><input id="reiniciar" type="button" value="Reiniciar" /> </a> 
</form>
