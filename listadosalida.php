...
$fecha=date('F');
$fecha=strftime('%B');
$Sql="INSERT INTO salidas(Mes,Fecha,Hora,Patente,Tipo_Operacion,Faena,Iso_Code,Contenedor,Consignatario,Observacion,numBL,Tipo_Bulto,Cantidad,Guia,Folio,Turno,Empleado,idIngreso) VALUES('".$fecha."','".date('y-m-d')."','".date('H:i:s')."','".$_POST['patente']."','".$_POST['operacion']."',".$_POST["faena"].",'".$_POST['isocode']."','".$_POST['contenedor']."','".$_POST['consignatario']."','".$_POST['observacion']."','".$_POST['nrobl']."','".$_POST['bulto']."','".$_POST['cantidad']."','".$_POST['guia']."','".$_POST['folio']."',0,'".$_SESSION['usuario']."','".$_POST['idingreso']."')";
...
?>
  ...
  <table width="180%" height="10%" border="1">
    <tr style="font:bold; background-color:#3CF">
      <td width="65" height="43">Mes</td>
